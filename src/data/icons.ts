...
export const contactIcons: Record<string, string> = {
  ...
  phone:
    '<svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M6.6 3h-2A1.6 1.6 0 0 0 3 4.6C3 13.1 10.9 21 19.4 21a1.6 1.6 0 0 0 1.6-1.6v-2a1.1 1.1 0 0 0-.85-1.07l-3.4-.8a1.1 1.1 0 0 0-1.14.44l-.9 1.24a13.2 13.2 0 0 1-5.32-5.32l1.24-.9a1.1 1.1 0 0 0 .44-1.14l-.8-3.4A1.1 1.1 0 0 0 6.6 3Z"/></svg>',
  github:
